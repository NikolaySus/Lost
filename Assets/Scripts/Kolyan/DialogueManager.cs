...
public class DialogueManager : MonoBehaviour
{
    ...
    private const string PLAYER_PORTRAIT_TAG = "player";
    ...
    public void EnterDialogueMode(TextAsset inkJSON/*, Animator emoteAnimator*/)
    {
        ...
        playerPortraitAnimator.Play("default");
    ...
    private void DisplayChoices()
    {
        ...
        {
            UnityEngine.Debug.LogError("More choices were given than the UI can support. Number of choices given: "
    ...
    public void MakeChoice(int choiceIndex)
    {
        if (canContinueToNextLine)
        {
            ...
            InputManager.GetInstance().GetSubmitPressed(); // this is specific to my InputManager script
            ContinueStory();
        }
    }
    ...
    public Ink.Runtime.Object GetVariableState(string variableName)
    {
        ...
        {
            UnityEngine.Debug.LogWarning("Ink Variable was found to be null: " + variableName);
        }
